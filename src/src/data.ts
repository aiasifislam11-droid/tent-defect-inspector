...
export const defectsData: Defect[] = [
  ...
  },
  {
    ...
    bengaliName: "পিই ওয়েল্ডিং সমস্যা",
    categories: ["Major", "Minor"],
    reasoning: {
  ...
  },
  {
    ...
    categories: ["Critical", "Major"],
    reasoning: {
      Critical: "টেন্ট যদি ঠিকমতো দাঁড়ানো না যায় বা পার্টস লক না হয়, অর্থাৎ মূল কাজই না করলে তা Critical।",
  ...
  },
  {
    ...
    categories: ["Major", "Minor"],
    reasoning: {
      Major: "সেলাইয়ের শুরুতে বা শেষে লক না থাকলে পুরো সেলাই খুলে যাওয়ার শতভাগ সুযোগ থাকে, তাই এটি Major।",
